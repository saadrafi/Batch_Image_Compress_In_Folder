...
def compress_image(input_path, output_path, type="webp", quality=85):
    with Image.open(input_path) as img:
        img.save(f"{output_path}.{type}", type, quality=quality)

# Function to compress all images in a given folder
def compress_images_in_folder(folder_name, output_folder="compressed_images", type="webp", quality=85):
